...
import com.example.pi_web.Dashboard_design;
...
public class Dashboard_IconsAndTabs extends Dashboard_design {
	...
	public Dashboard_IconsAndTabs() {
		//Upload
		upload_echeance_ajouter_annexe.addListener(new Upload.SucceededListener() {
		...
		upload_echeance_ajouter_annexe.addListener(new Upload.FailedListener() {
		...
		upload_etudiant_propositionStage_editer_annexe.addListener(new Upload.SucceededListener() {
            public void uploadSucceeded(SucceededEvent event) {
                // This method gets called when the upload finished successfully
		...
		upload_etudiant_propositionStage_editer_annexe.addListener(new Upload.FailedListener() {
            public void uploadFailed(FailedEvent event) {
                // This method gets called when the upload failed
            	Notification.show("Un problème est survenu lors de l'upload du fichier", Notification.TYPE_ERROR_MESSAGE);
            }
		...
		upload_professeur_propositionStage_editer_annexe.addListener(new Upload.SucceededListener() {
            public void uploadSucceeded(SucceededEvent event) {
                // This method gets called when the upload finished successfully
            	upload_echeance_ajouter_annexe.setVisible(false);
            	Notification.show("Le fichier a bien été uploadé", Notification.TYPE_TRAY_NOTIFICATION);
		...
		upload_professeur_propositionStage_editer_annexe.addListener(new Upload.FailedListener() {
            public void uploadFailed(FailedEvent event) {
                // This method gets called when the upload failed
            	Notification.show("Un problème est survenu lors de l'upload du fichier", Notification.TYPE_ERROR_MESSAGE);
            }
