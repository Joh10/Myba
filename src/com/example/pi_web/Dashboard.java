...
public class Dashboard extends Dashboard_IconsAndTabs implements View {
	...
	public Dashboard() {
		...
		// ADMINISTRATION
		onglets_administration.addSelectedTabChangeListener(
				new TabSheet.SelectedTabChangeListener() {
					public void selectedTabChange(SelectedTabChangeEvent event) {
						unselectSelectedTab();
						TabSheet tabsheet = event.getTabSheet();
		...
		// PROFESSEURS
		onglets_prof.addSelectedTabChangeListener(
				new TabSheet.SelectedTabChangeListener() {
					public void selectedTabChange(SelectedTabChangeEvent event) {
						unselectSelectedTab();
						TabSheet tabsheet = event.getTabSheet();
		...
		// ETUDIANT
		onglets_etudiant.addSelectedTabChangeListener(
				new TabSheet.SelectedTabChangeListener() {
					public void selectedTabChange(SelectedTabChangeEvent event) {
						unselectSelectedTab();
						TabSheet tabsheet = event.getTabSheet();
		...
		// * * * MON COMPTE * * *
		button_monCompte.addClickListener(
				new ClickListener() {
		...
		// * * * DECONNEXION * * *
		button_deconnexion.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						removeAllClickShortcuts();
						unselectSelectedTab();
		...
		button_professeur_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						try {
		...
		button_professeur_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_prof.setVisible(false);
						button_professeur_valider.removeClickShortcut();
		...
		modifier2.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						...
						tf_etudiant_mdp.setValue("");
						button_etudiant_valider.setClickShortcut(KeyCode.ENTER);
						if(user.getRole().getNom().equals("etudiant_tfe"))
		...
		button_etudiant_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {						
						try {
							...
							Role role = null;
							if(permission.equals("TFE"))
								role = new Role("etudiant_tfe");
							else if (permission.equals("TFE et Stage"))
								role = new Role("etudiant_tfe_stage");
		...
		button_etudiant_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_etudiant.setVisible(false);
						button_etudiant_valider.removeClickShortcut();
		...
		button_maitreDeStage_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_maitreDeStage_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_maitreDeStage.setVisible(false);
						button_maitreDeStage_valider.removeClickShortcut();
		...
		button_presidentDeJury_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_presidentDeJury_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_presidentDeJury.setVisible(false);
						button_presidentDeJury_valider.removeClickShortcut();
		...
		button_entreprise_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_entreprise_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_entreprise.setVisible(false);
						button_entreprise_valider.removeClickShortcut();
		...
		button_critereEvaluation_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						try {
		...
		button_critereEvaluation_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_critereEvaluation_editer.setVisible(false);
						button_critereEvaluation_valider.removeClickShortcut();
		...
		button_technologie_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_technologie_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_technologie.setVisible(false);
						button_technologie_valider.removeClickShortcut();
		...
		// TFE
		// Ajouter un TFE
		button_ajouterTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		// valider ajouter TFE
		button_tfe_ajouter_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						try {
							...
							Set<Technologie> temp = (Set<Technologie>) tc_tfe_ajouter_technologie.getValue();
		...
		button_tfe_modifier_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						...
						@SuppressWarnings("unchecked")
						Set<Technologie> temp = (Set<Technologie>) tc_tfe_modifier_technologie.getValue();
						ArrayList<Technologie> technologies = new ArrayList<Technologie>(temp);
		...
		// Annuler ajouter TFE
		button_tfe_ajouter_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_TFE_ajouter.setVisible(false);
						form_TFE_ajouter2.setVisible(false);
		...
		button_tfe_modifier_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_TFE_modifier.setVisible(false);
						form_TFE_modifier2.setVisible(false);
		...
		// Modifier un TFE
		button_modifierTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						DAO_TFE tfe_DB = new DAO_TFE();
		...
		// Supprimer un TFE
		button_supprimerTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
						ConfirmDialog.show((UI)getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener() {
		...
		// Evaluer un TFE
		button_evaluerTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// Retour TFE 2
		button_retour_TFE2.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
		...
		// Ajouter evaluation
		buton_ajouter_evaluationTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		// Modifier evaluation
		button_modifier_evaluationTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
		...
		button_supprimer_evaluationTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// Valider evaluer TFE
		button_tfe_evaluer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						try {
		...
		// Annuler evaluer TFE
		button_tfe_evaluer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_TFE_evaluer.setVisible(false);
						button_tfe_evaluer_valider.removeClickShortcut();
		...
		button_defenseTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_tfe_defense_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_tfe_defense_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_TFE_defense.setVisible(false);
						button_tfe_defense_valider.removeClickShortcut();
		...
		button_echeanceTFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// Retour TFE
		button_retour_TFE.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
						button_ajouterTFE.setVisible(true);
		...
		button_TFE_ajouterEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		button_TFE_modifierEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
		...
		button_TFE_supprimerEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// Valider echance TFE
		button_tfe_echeance_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_tfe_echeance_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_TFE_echeance.setVisible(false);
						button_tfe_echeance_valider.removeClickShortcut();
		...
		button_stage_editer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						...
						@SuppressWarnings("unchecked")
						Set<Technologie> temp = (Set<Technologie>) tc_stage_editer_technologies.getValue();
						ArrayList<Technologie> technologies = new ArrayList<Technologie>(temp);
		...
		button_stage_editer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_stage_editer.setVisible(false);
						form_stage_editer2.setVisible(false);
		...
		// Modifier un stage
		button_modifierStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						DAO_Stage stage_DB = new DAO_Stage();
		...
		// Supprimer un stage
		button_supprimerStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
						ConfirmDialog.show((UI)getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener() {
		...
		// Retour stages 2
		button_retour_Stage2.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
		...
		// Evaluer un stage
		button_evaluerStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						if(currentUser.getRole().isAllowed("professor_manage_evaluations")) {
		...
		buton_ajouter_evaluationStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		button_modifier_evaluationStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						DAO_Evaluation evaluation_DB = new DAO_Evaluation();
		...
		button_supprimer_evaluationStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_stage_evaluer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						try {
		...
		button_stage_evaluer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_stage_evaluer.setVisible(false);
						button_stage_evaluer_valider.removeClickShortcut();
		...
		button_defenseStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						if(currentUser.getRole().isAllowed("professor_manage_defenses")) {
							hideForms();
		...
		button_stage_defense_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_stage_defense_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_stage_defense.setVisible(false);
						button_stage_defense_valider.removeClickShortcut();
		...
		button_echeanceStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						if(currentUser.getRole().isAllowed("professor_manage_planning")) {
							hideForms();
		...
		// Retour stages
		button_retour_Stage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
						button_modifierStage.setVisible(true);
		...
		button_stage_ajouterEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		button_stage_modifierEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						DAO_Echeance echeance_DB = new DAO_Echeance();
		...
		button_stage_supprimerEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						ConfirmDialog.show((UI)getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener() {
							public void onClose (ConfirmDialog dialog) {
		...
		button_stage_echeance_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_stage_echeance_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_stage_echeance.setVisible(false);
						button_stage_echeance_valider.removeClickShortcut();
		...
		// Commenter un stage
		button_commenterStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
		...
		button_stage_commenter_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_stage_commenter_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_stage_commenter.setVisible(false);
						button_stage_commenter_valider.removeClickShortcut();
		...
		button_propositionStage_editer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						String sujet = tf_PropositionStage_editer_sujet.getValue();
						String file = "";
						if(fileUploaded != null)
							file = fileUploaded.getName();
						...
						if(!sujet.isEmpty()) {
							...
							if(modification) {
								...
								if(file == "")
									file = propositionStage.getAnnexe();
		...
		button_propositionStage_editer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_propositionStage_editer.setVisible(false);
						button_propositionStage_editer_valider.removeClickShortcut();
		...
		button_ajouterPropositionStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
						cb_PropositionStage_editer_entreprise.setReadOnly(false);
		...
		button_modifierPropositionStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						cb_PropositionStage_editer_entreprise.setReadOnly(false);
		...
		button_supprimerPropositionStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						hideForms();
						ConfirmDialog.show((UI)getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener() {
		...
		button_validerPropositionStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						DAO_PropositionStage propositionStage_DB = new DAO_PropositionStage();
						PropositionStage propositionStage = propositionStage_DB.find(Integer.parseInt(elementSelected.toString()));
		...
		button_propositionStage_valider_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						...
						@SuppressWarnings("unchecked")
						Set<Technologie> temp = (Set<Technologie>) tc_PropositionStage_valider_technologies.getValue();
						ArrayList<Technologie> technologies = new ArrayList<Technologie>(temp);
						DAO_PropositionStage propositionStage_DB = new DAO_PropositionStage();
						PropositionStage propositionStage = propositionStage_DB.find((int)elementSelected);
						if(!sujet.isEmpty() && dateDebut != null && dateFin != null && maitreStage != null && promoteur != null) {
		...
		button_propositionStage_valider_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_propositionStage_valider.setVisible(false);
						form_propositionStage_valider2.setVisible(false);
		...
		button_defense_editer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_defense_editer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_defense_editer.setVisible(false);
						button_defense_editer_valider.removeClickShortcut();
		...
		button_modifierDefense.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						DAO_Defense defense_DB = new DAO_Defense();
		...
		button_supprimerDefense.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_defense_editer.setVisible(false);
		...
		// Retour défenses
		button_retour_Defense.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// Evaluer une defense
		button_evaluerDefense.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						load_cb_defense();
		...
		button_ajouter_evaluationDefense.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		button_modifier_evaluationDefense.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						DAO_Evaluation evaluation_DB = new DAO_Evaluation();
		...
		button_supprimer_evaluationDefense.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_defense_evaluer.setVisible(false);
						ConfirmDialog.show((UI)getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener() {
							public void onClose (ConfirmDialog dialog) {
								if(dialog.isConfirmed()) {
									...
									if(evaluation_DB.delete(evaluation)) {
										...
										if(evaluation.getStage() != null)
											calculPointsStage(evaluation.getStage());
										else if(evaluation.getTFE() != null)
											calculPointsTFE(evaluation.getTFE());
		...
		button_defense_evaluer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						try {
		...
		button_defense_evaluer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_defense_evaluer.setVisible(false);
						button_defense_evaluer_valider.removeClickShortcut();
		...
		// ECHEANCES
		// Ajouter echeance
		button_ajouterEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		// Modifier echeance
		button_modifierEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {						
						modification = true;
						DAO_Echeance echeance_DB = new DAO_Echeance();
		...
		// Supprimer echeance
		button_supprimerEcheance.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						ConfirmDialog.show((UI)getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener() {
							public void onClose (ConfirmDialog dialog) {
		...
		button_echeance_editer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						String description = tf_echeance_ajouter_description.getValue();
						Date date = date_echeance_ajouter_date.getValue();
						@SuppressWarnings("unchecked")
						Set<Utilisateur> temp = (Set<Utilisateur>) tc_echeance_ajouter_utilisateurs.getValue();
		...
		button_echeance_editer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_echeance_editer.setVisible(false);
						form_echeance_editer2.setVisible(false);
		...
		// proposition de stage
		// Ajouter entreprise
		button_etudiant_ajouterEntreprise.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_propositionStage_etudiant_editer.setVisible(false);
		...
		button_entreprise_valider2.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_entreprise_annuler2.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_propositionStage_etudiant_editer.setVisible(true);
						form_propositionStage_etudiant_ajouterEntreprise.setVisible(false);
		...
		// ajouter
		button_ajouterPropositionStage3.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = false;
		...
		// modifier
		button_modifierPropositionStage3.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						modification = true;
						DAO_PropositionStage propositionStage_DB = new DAO_PropositionStage();
		...
		// valider editer
		button_propositionStage_etudiant_editer_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// annuler editer
		button_propositionStage_etudiant_editer_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_propositionStage_etudiant_editer.setVisible(false);
						button_propositionStage_etudiant_editer_valider.removeClickShortcut();
		...
		// supprimer
		button_supprimerPropositionStage3.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_propositionStage_etudiant_editer.setVisible(false);
						ConfirmDialog.show((UI)getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener() {
		...
		// dupliquer
		button_dupliquerPropositionStage3.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {						
						modification = false;
						DAO_PropositionStage propositionStage_DB = new DAO_PropositionStage();
		...
		// * * * MAITRE DE STAGE * * *
		// evaluer stage
		button_evaluerStage_maitreDeStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// modifier evaluation
		button_modifierEvaluation_maitreDeStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						DAO_Evaluation evaluation_DB = new DAO_Evaluation();
		...
		// supprimer evaluation
		button_supprimerEvaluation_maitreDeStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// retour
		button_retour_maitreDeStage.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_stage_maitreDeStage_evaluer.setVisible(false);
		...
		button_stage_evaluer_maitreDeStage_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_stage_evaluer_maitreDeStage_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_stage_maitreDeStage_evaluer.setVisible(false);
						button_stage_evaluer_maitreDeStage_valider.removeClickShortcut();
		...
		// * * * PRESIDENT DE JURY * * *
		// evaluer defense
		button_evaluerDefense_presidentDeJury.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						stage_evaluer_maitreDeStage_critere.clear();
						stage_evaluer_maitreDeStage_critere.setVisible(true);
		...
		// modifier evaluation
		button_modifierEvaluation_presidentDeJury.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						DAO_Evaluation evaluation_DB = new DAO_Evaluation();
						Evaluation evaluation = evaluation_DB.find(Integer.parseInt(elementSelected.toString()));
		...
		// supprimer evaluation
		button_supprimerEvaluation_presidentDeJury.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		// retour
		button_retour_presidentDeJury.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_defense_evaluer_presidentDeJury.setVisible(false);
		...
		button_defense_evaluer_presidentDeJury_valider.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
		...
		button_defense_evaluer_presidentDeJury_annuler.addClickListener(
				new ClickListener() {
					public void buttonClick(ClickEvent event) {
						form_defense_evaluer_presidentDeJury.setVisible(false);
						button_defense_evaluer_presidentDeJury_valider.removeClickShortcut();
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(elementSelected != null) {
					...
					if(propositionStage.getOwner().getRole().getNom().equals("professeur"))
						...
						button_validerPropositionStage.setEnabled(true);
				}
	...
	public void load_tab_echeance() {
		...
		for(Echeance echeance: echeanceList) {
			String type = "";
			if(echeance.getTFE() != null)
				type = "TFE";
			else if(echeance.getStage() != null)
				type = "Stage";
			else
				type = "Utilisateur";
	...
	public void load_tab_echeance2() {
		...
		tab_echeance2.addValueChangeListener(new Property.ValueChangeListener() {
			public void valueChange(ValueChangeEvent event) {
				...
				boolean boutons = false;
				if(elementSelected == null)
					button_modifierEcheance.setEnabled(false);
				else {
					boutons = true;
					Echeance ech = echeance_DB.find(Integer.parseInt(elementSelected.toString()));
					if(ech.getTFE() == null && ech.getStage() == null)
						button_modifierEcheance.setEnabled(true);
					else
						button_modifierEcheance.setEnabled(false);
				}
	...
	public void load_tab_defense2() {
		...
		for(Defense defense : defenseList) {
			...
			String promoteur = "";
			if(defense.getStage() != null)
				promoteur = defense.getStage().getSuperviseur().toString();
			else if(defense.getTFE() !=  null)
				promoteur = defense.getTFE().getPromoteur().toString();
	...
	private ArrayList<String> tfe_generer_anneesAcademiques(ArrayList<TFE> listTfe) {
		...
		for(TFE tfe : listTfe) {
			...
			if(!retour.contains(proposition))
	...
	public void unselectSelectedTab() {
		if(elementSelected != null)
			selectedTab.unselect(elementSelected);
		elementSelected = null;
		modification = false;
	}
	...
	public void enter(ViewChangeEvent event) {
		...
		if(currentUser == null)
			...
			if(currentUser.getRole().isAllowed("professor_management")) {
				...
				onglets.getTab(onglet_professeurs).setVisible(false);
			if(currentUser.getRole().isAllowed("student_management")) {
				...
				onglets.getTab(onglet_etudiants).setVisible(false);
