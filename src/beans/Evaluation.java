...
public class Evaluation {
	 ...
	 * @exception IllegalArgumentException si le critère n'est pas de type TFE
	 * @exception IllegalArgumentException si la note attribuée est supérieure à la note maximale du critère
	 */
	public Evaluation(int _id, Date _date, Utilisateur _owner, CritereEvaluation _critere, TFE _tfe, double _note, String _commentaire) {
		if(!_critere.getType().equals("tfe"))
			throw new IllegalArgumentException("Le critère doit concerner un TFE");
	 ...
	 * @param	_note		La note attribuée à cette évaluation
	 * @param	_commentaire	Le commentaire assigné à cette évaluation
	 * @exception IllegalArgumentException si le critère n'est pas de type stage
	 * @exception IllegalArgumentException si la note attribuée est supérieure à la note maximale du critère
	 */
