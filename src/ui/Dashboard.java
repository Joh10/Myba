...
public class Dashboard extends Dashboard_IconsAndTabs implements View
{
    ...
    public Dashboard()
    {
        ...
        onglets.addSelectedTabChangeListener((TabSheet.SelectedTabChangeListener) event -> {
            ...
            if (caption.equals("Administration"))
            {
                ...
                load_tab_professeurs();
            } else if (caption.equals("Professeurs"))
            {
                unselectSelectedTab();
                hideForms();
                removeAllClickShortcuts();
                load_tab_tfe();
            } else if (caption.equals("Etudiants"))
            {
                unselectSelectedTab();
                hideForms();
                removeAllClickShortcuts();
                load_tab_tfe2();
            } else if (caption.equals("Maitre de stage"))
            {
                unselectSelectedTab();
                hideForms();
                removeAllClickShortcuts();
                load_tab_stage3();
            } else if (caption.equals("Président de jury"))
            {
                unselectSelectedTab();
                hideForms();
                removeAllClickShortcuts();
        ...
        onglets_administration.addSelectedTabChangeListener((TabSheet.SelectedTabChangeListener) event ->
        {
            ...
            String caption = tabsheet.getTab(tab).getCaption();
            removeAllClickShortcuts();
            if (caption.equals("Gérer les professeurs"))
            {
                unselectSelectedTab();
                load_tab_professeurs();
                hideForms();
            } else if (caption.equals("Gérer les étudiants"))
            {
                unselectSelectedTab();
                load_tab_etudiants();
                hideForms();
            } else if (caption.equals("Gérer les maitres de stage"))
            {
                unselectSelectedTab();
                load_tab_maitresDeStage();
                hideForms();
            } else if (caption.equals("Gérer les présidents de jury"))
            {
                unselectSelectedTab();
                load_tab_presidentsDeJury();
                hideForms();
            } else if (caption.equals("Gérer les entreprises"))
            {
                unselectSelectedTab();
                load_tab_entreprises();
                hideForms();
            } else if (caption.equals("Gérer les critères d'évaluation"))
            {
                unselectSelectedTab();
                load_tab_criteresEvaluation();
                load_cb_critereEvaluation();
                hideForms();
            } else if (caption.equals("Gérer les technologies"))
            {
                unselectSelectedTab();
        ...
        onglets_prof.addSelectedTabChangeListener((TabSheet.SelectedTabChangeListener) event ->
        {
            ...
            String caption = tabsheet.getTab(tab).getCaption();
            removeAllClickShortcuts();
            if (caption.equals("Gérer les TFE"))
            {
                unselectSelectedTab();
                load_tab_tfe();
                hideForms();
            } else if (caption.equals("Gérer les stages"))
            {
                unselectSelectedTab();
                load_tab_stage();
                hideForms();
            } else if (caption.equals("Gérer les propositions de stage"))
            {
                unselectSelectedTab();
                load_tab_propositionStage();
                hideForms();
            } else if (caption.equals("Gérer les défenses"))
            {
                unselectSelectedTab();
                load_tab_defense();
                hideForms();
            } else if (caption.equals("Gérer les échéances"))
            {
                unselectSelectedTab();
                load_tab_echeance2();
                hideForms();
        ...
        onglets_etudiant.addSelectedTabChangeListener((TabSheet.SelectedTabChangeListener) event ->
        {
            ...
            String caption = tabsheet.getTab(tab).getCaption();
            removeAllClickShortcuts();
            if (caption.equals("Consulter les TFE"))
            {
                unselectSelectedTab();
                load_tab_tfe2();
            } else if (caption.equals("Consulter les stages"))
            {
                unselectSelectedTab();
                load_tab_stage2();
            } else if (caption.equals("Gérer mes propositions de stage"))
            {
                unselectSelectedTab();
                form_propositionStage_etudiant_editer.setVisible(false);
                load_tab_propositionStage2();
            } else if (caption.equals("Consulter mes échéances"))
            {
                unselectSelectedTab();
                load_tab_echeance();
            } else if (caption.equals("Consulter mes défenses"))
            {
                unselectSelectedTab();
                load_tab_defense2();
            } else if (caption.equals("Consulter les entreprises"))
            {
                unselectSelectedTab();
        ...
        modifier.addClickListener((ClickListener) event ->
        {
            ...
            tf_professeur_adresseMail.setValue(user.getEmail().toString());
            tf_professeur_tel.setValue(user.getTelephone().toString());
        ...
        {
            form_prof.setVisible(false);
            ConfirmDialog.show((UI) getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener()
            {
        ...
        supprimer2.addClickListener(new ClickListener()
        {
        ...
        ajouter3.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        modifier3.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_maitreDeStage_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_maitreDeStage_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_maitreDeStage.setVisible(false);
        ...
        supprimer3.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_maitreDeStage.setVisible(false);
        ...
        ajouter4.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        modifier4.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_presidentDeJury_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_presidentDeJury_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_presidentDeJury.setVisible(false);
        ...
        supprimer4.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_presidentDeJury.setVisible(false);
        ...
        ajouter5.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        modifier5.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_entreprise_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_entreprise_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_entreprise.setVisible(false);
        ...
        supprimer5.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_entreprise.setVisible(false);
        ...
        ajouter6.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        modifier6.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_critereEvaluation_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                try
        ...
        button_critereEvaluation_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_critereEvaluation_editer.setVisible(false);
        ...
        supprimer6.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_critereEvaluation_editer.setVisible(false);
        ...
        ajouter7.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        modifier7.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_technologie_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_technologie_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_technologie.setVisible(false);
        ...
        supprimer7.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_technologie.setVisible(false);
        ...
        // TFE
        // Ajouter un TFE
        button_ajouterTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        // valider ajouter TFE
        button_tfe_ajouter_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                try
                {
                    ...
                    ArrayList<Technologie> technologies = new ArrayList<Technologie>(temp);
        ...
        button_tfe_modifier_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // Annuler ajouter TFE
        button_tfe_ajouter_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_TFE_ajouter.setVisible(false);
        ...
        button_tfe_modifier_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_TFE_modifier.setVisible(false);
        ...
        // Modifier un TFE
        button_modifierTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
                ...
                HashSet<Technologie> preselected = new HashSet<Technologie>(tfe.getTechnologies());
        ...
        // Supprimer un TFE
        button_supprimerTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        // Evaluer un TFE
        button_evaluerTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // Retour TFE 2
        button_retour_TFE2.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        // Ajouter evaluation
        buton_ajouter_evaluationTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        // Modifier evaluation
        button_modifier_evaluationTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_supprimer_evaluationTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // Valider evaluer TFE
        button_tfe_evaluer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                try
                {
                    ...
                    if (modification)
                    {
                        ...
                        if (note != null && note > 0 && note <= evaluation.getCritere().getNote())
                        {
                    ...
                    {
                        if (critere != null && note != null && note > 0 && date != null && note <= critere.getNote())
                        {
                            DAO_Evaluation evaluation_DB = new DAO_Evaluation();
        ...
        // Annuler evaluer TFE
        button_tfe_evaluer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_TFE_evaluer.setVisible(false);
        ...
        button_defenseTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_tfe_defense_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_tfe_defense_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_TFE_defense.setVisible(false);
        ...
        button_echeanceTFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // Retour TFE
        button_retour_TFE.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        button_TFE_ajouterEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        button_TFE_modifierEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_TFE_supprimerEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // Valider echance TFE
        button_tfe_echeance_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_tfe_echeance_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_TFE_echeance.setVisible(false);
        ...
        button_stage_editer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_stage_editer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_stage_editer.setVisible(false);
        ...
        // Modifier un stage
        button_modifierStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
                ...
                HashSet<Technologie> preselected = new HashSet<Technologie>(stage.getTechnologies());
        ...
        // Supprimer un stage
        button_supprimerStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        // Retour stages 2
        button_retour_Stage2.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        // Evaluer un stage
        button_evaluerStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                if (currentUser.getRole().isAllowed("professor_manage_evaluations"))
        ...
        buton_ajouter_evaluationStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        button_modifier_evaluationStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_supprimer_evaluationStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_stage_evaluer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                try
        ...
        button_stage_evaluer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_stage_evaluer.setVisible(false);
        ...
        button_defenseStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                if (currentUser.getRole().isAllowed("professor_manage_defenses"))
        ...
        button_stage_defense_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_stage_defense_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_stage_defense.setVisible(false);
        ...
        button_echeanceStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                if (currentUser.getRole().isAllowed("professor_manage_planning"))
        ...
        // Retour stages
        button_retour_Stage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        button_stage_ajouterEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        button_stage_modifierEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_stage_supprimerEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                ConfirmDialog.show((UI) getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener()
        ...
        button_stage_echeance_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_stage_echeance_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_stage_echeance.setVisible(false);
        ...
        // Commenter un stage
        button_commenterStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        button_stage_commenter_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_stage_commenter_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_stage_commenter.setVisible(false);
        ...
        button_propositionStage_editer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_propositionStage_editer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_propositionStage_editer.setVisible(false);
        ...
        button_ajouterPropositionStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        button_modifierPropositionStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_supprimerPropositionStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                hideForms();
        ...
        button_validerPropositionStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                DAO_PropositionStage propositionStage_DB = new DAO_PropositionStage();
        ...
        button_propositionStage_valider_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_propositionStage_valider_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_propositionStage_valider.setVisible(false);
        ...
        button_defense_editer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_defense_editer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_defense_editer.setVisible(false);
        ...
        button_modifierDefense.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_supprimerDefense.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_defense_editer.setVisible(false);
        ...
        // Retour défenses
        button_retour_Defense.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // Evaluer une defense
        button_evaluerDefense.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                load_cb_defense();
        ...
        button_ajouter_evaluationDefense.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        button_modifier_evaluationDefense.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        button_supprimer_evaluationDefense.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_defense_evaluer.setVisible(false);
        ...
        button_defense_evaluer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                try
                {
                    ...
                    if (modification)
                    {
                        if (note != null && note > 0 && commentaire != null)
                        {
                            DAO_Evaluation evaluation_DB = new DAO_Evaluation();
                            Evaluation evaluation = evaluation_DB.find((int) elementSelected);
        ...
        button_defense_evaluer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_defense_evaluer.setVisible(false);
        ...
        // ECHEANCES
        // Ajouter echeance
        button_ajouterEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        // Modifier echeance
        button_modifierEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
                ...
                HashSet<Utilisateur> preselected = new HashSet<Utilisateur>(echeance.getUsers());
        ...
        // Supprimer echeance
        button_supprimerEcheance.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                ConfirmDialog.show((UI) getParent(), "Veuillez confirmer:", "Etes-vous certain de vouloir supprimer ?", "Oui", "Non", new ConfirmDialog.Listener()
        ...
        button_echeance_editer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                ...
                ArrayList<Utilisateur> etudiants = new ArrayList<Utilisateur>(temp);
                String file = "";
                if (fileUploaded != null) file = fileUploaded.getName();
        ...
        button_echeance_editer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_echeance_editer.setVisible(false);
        ...
        // proposition de stage
        // Ajouter entreprise
        button_etudiant_ajouterEntreprise.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_propositionStage_etudiant_editer.setVisible(false);
        ...
        button_entreprise_valider2.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_entreprise_annuler2.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_propositionStage_etudiant_editer.setVisible(true);
        ...
        // ajouter
        button_ajouterPropositionStage3.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        // modifier
        button_modifierPropositionStage3.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = true;
        ...
        // valider editer
        button_propositionStage_etudiant_editer_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // annuler editer
        button_propositionStage_etudiant_editer_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_propositionStage_etudiant_editer.setVisible(false);
        ...
        // supprimer
        button_supprimerPropositionStage3.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_propositionStage_etudiant_editer.setVisible(false);
        ...
        // dupliquer
        button_dupliquerPropositionStage3.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                modification = false;
        ...
        // * * * MAITRE DE STAGE * * *
        // evaluer stage
        button_evaluerStage_maitreDeStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // modifier evaluation
        button_modifierEvaluation_maitreDeStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                DAO_Evaluation evaluation_DB = new DAO_Evaluation();
        ...
        // supprimer evaluation
        button_supprimerEvaluation_maitreDeStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // retour
        button_retour_maitreDeStage.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_stage_maitreDeStage_evaluer.setVisible(false);
        ...
        button_stage_evaluer_maitreDeStage_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_stage_evaluer_maitreDeStage_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_stage_maitreDeStage_evaluer.setVisible(false);
        ...
        // * * * PRESIDENT DE JURY * * *
        // evaluer defense
        button_evaluerDefense_presidentDeJury.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                stage_evaluer_maitreDeStage_critere.clear();
        ...
        // modifier evaluation
        button_modifierEvaluation_presidentDeJury.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                DAO_Evaluation evaluation_DB = new DAO_Evaluation();
        ...
        // supprimer evaluation
        button_supprimerEvaluation_presidentDeJury.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        // retour
        button_retour_presidentDeJury.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_defense_evaluer_presidentDeJury.setVisible(false);
        ...
        button_defense_evaluer_presidentDeJury_valider.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
        ...
        button_defense_evaluer_presidentDeJury_annuler.addClickListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                form_defense_evaluer_presidentDeJury.setVisible(false);
    ...
    public void load_tab_etudiants()
    {
        ...
        tab_etudiants.addValueChangeListener(new Property.ValueChangeListener()
        {
        ...
        tf_etudiant_recherche.addTextChangeListener(new TextChangeListener()
        {
    ...
    public void load_tab_etudiants_filtre()
    {
        ...
        ArrayList<Utilisateur> userList = user_DB.fetchAll("etudiant_tfe");
        userList.addAll(user_DB.fetchAll("etudiant_tfe_stage"));
        for (Utilisateur etudiant : userList)
        {
            if (tf_etudiant_recherche.isEmpty() || (etudiant.toString().toLowerCase().contains(tf_etudiant_recherche.getValue().toLowerCase())))
                tab_etudiants.addItem(new Object[]{etudiant.getNom(), etudiant.getPrenom(), etudiant.getMatricule(), etudiant.getEmail(), etudiant.getTelephone()}, etudiant.getId());
        }
    }
    ...
    public void load_tab_professeurs()
    {
        ...
        tab_professeurs.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_prof.setVisible(false);
        ...
        tf_professeur_recherche.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_tab_professeurs_filtre()
    {
        ...
        DAO_Utilisateur user_DB = new DAO_Utilisateur();
        ArrayList<Utilisateur> userList = user_DB.fetchAll("professeur");
        for (Utilisateur professeur : userList)
        {
            if (tf_professeur_recherche.isEmpty() || (professeur.toString().toLowerCase().contains(tf_professeur_recherche.getValue().toLowerCase())))
                tab_professeurs.addItem(new Object[]{professeur.getNom(), professeur.getPrenom(), professeur.getEmail(), professeur.getTelephone()}, professeur.getId());
        }
    }
    ...
    public void load_tab_maitresDeStage()
    {
        ...
        tab_maitresDeStage.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_maitreDeStage.setVisible(false);
        ...
        tf_maitreDeStage_recherche.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_tab_maitresDeStage_filtre()
    {
        ...
        DAO_Utilisateur user_DB = new DAO_Utilisateur();
        ArrayList<Utilisateur> userList = user_DB.fetchAll("maitre_stage");
        for (Utilisateur maitreStage : userList)
        {
            if (tf_maitreDeStage_recherche.isEmpty() || (maitreStage.toString().toLowerCase().contains(tf_maitreDeStage_recherche.getValue().toLowerCase())))
                tab_maitresDeStage.addItem(new Object[]{maitreStage.getNom(), maitreStage.getPrenom(), maitreStage.getTelephone(), maitreStage.getEmail()}, maitreStage.getId());
        }
    }
    ...
    public void load_tab_presidentsDeJury()
    {
        ...
        tab_presidentsDeJury.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_presidentDeJury.setVisible(false);
        ...
        tf_presidentDeJury_recherche.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_tab_presidentsDeJury_filtre()
    {
        ...
        DAO_Utilisateur user_DB = new DAO_Utilisateur();
        ArrayList<Utilisateur> userList = user_DB.fetchAll("president_jury");
        for (Utilisateur presidentJury : userList)
        {
            if (tf_presidentDeJury_recherche.isEmpty() || (presidentJury.toString().toLowerCase().contains(tf_presidentDeJury_recherche.getValue().toLowerCase())))
                tab_presidentsDeJury.addItem(new Object[]{presidentJury.getNom(), presidentJury.getPrenom(), presidentJury.getTelephone(), presidentJury.getEmail()}, presidentJury.getId());
        }
    }
    ...
    public void load_tab_entreprises()
    {
        ...
        tab_entreprises.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_entreprise.setVisible(false);
        ...
        tf_entreprise_recherche.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_tab_entreprises_etudiant()
    {
        ...
        tf_entreprise_recherche3.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_tab_entreprises_filtre()
    {
        ...
        for (LieuStage lieuStage : lieuStageList)
        {
            if (tf_entreprise_recherche.isEmpty() || (lieuStage.getNom().toLowerCase().contains(tf_entreprise_recherche.getValue().toLowerCase())) || (lieuStage.getAdresse().toLowerCase().contains(tf_entreprise_recherche.getValue().toLowerCase())))
                tab_entreprises.addItem(new Object[]{lieuStage.getNom(), lieuStage.getAdresse(), lieuStage.getContact(), lieuStage.getTelephone()}, lieuStage.getId());
        }
    }
    ...
    public void load_tab_entreprises_etudiant_filtre()
    {
        ...
        for (LieuStage lieuStage : lieuStageList)
        {
            if (tf_entreprise_recherche3.isEmpty() || (lieuStage.getNom().toLowerCase().contains(tf_entreprise_recherche3.getValue().toLowerCase())) || (lieuStage.getAdresse().toLowerCase().contains(tf_entreprise_recherche3.getValue().toLowerCase())))
                tab_entreprises3.addItem(new Object[]{lieuStage.getNom(), lieuStage.getAdresse(), lieuStage.getContact(), lieuStage.getTelephone()}, lieuStage.getId());
        }
    }
    ...
    public void load_tab_criteresEvaluation()
    {
        ...
        tab_criteresEvaluation.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_critereEvaluation_editer.setVisible(false);
        ...
        tf_evaluation_recherche.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_tab_criteresEvaluation_filtre()
    {
        ...
        for (CritereEvaluation critereEvaluation : critereEvaluationList)
        {
            if (tf_evaluation_recherche.isEmpty() || (critereEvaluation.getNom().toLowerCase().contains(tf_evaluation_recherche.getValue().toLowerCase())))
                tab_criteresEvaluation.addItem(new Object[]{critereEvaluation.getNom(), critereEvaluation.getType(), critereEvaluation.getNote()}, critereEvaluation.getId());
        }
    }
    ...
    public void load_tab_technologies()
    {
        ...
        tab_technologies.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_technologie.setVisible(false);
        ...
        tf_technologie_recherche.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_tab_technologies_filtre()
    {
        ...
        for (Technologie technologie : technologieList)
        {
            if (tf_technologie_recherche.isEmpty() || (technologie.getNom().toLowerCase().contains(tf_technologie_recherche.getValue().toLowerCase())))
                tab_technologies.addItem(new Object[]{technologie.getNom(), technologie.getVersion()}, technologie.getId());
        }
    }
    ...
    public void load_tab_tfe()
    {
        ...
        tab_tfe.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                hideForms();
    ...
    public void load_tab_tfe2_filtre()
    {
        ...
        for (TFE tfe : tfeList)
        {
            ...
            int anneeFin = tfe.getAnneeFin();
            String nomPrenom = (tfe.getOwner().toString()).toLowerCase();
            if (((technologie != null && technologiesTFE.contains(technologie)) || technologie == null) && ((cb_tfe_anneeAcademique2.getValue() != null && ((anneeDebut >= anneeAcademiqueDebut) && (anneeFin == anneeAcademiqueDebut || anneeFin == anneeAcademiqueFin))) || cb_tfe_anneeAcademique2.getValue() == null) && ((nom != null && nomPrenom.contains(nom)) || nom == null))
    ...
    public void load_tab_stage()
    {
        ...
        tab_stage.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                hideForms();
    ...
    public void load_tab_propositionStage()
    {
        ...
        tab_propositionStage.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                hideForms();
    ...
    public void load_tab_defense()
    {
        ...
        tab_defense.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_defense_editer.setVisible(false);
    ...
    public void load_tab_evaluationTFE(TFE tfe)
    {
        ...
        tab_evaluationTFE.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_TFE_evaluer.setVisible(false);
    ...
    public void load_tab_evaluationStage(Stage stage)
    {
        ...
        tab_evaluationStage.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_stage_evaluer.setVisible(false);
    ...
    public void load_tab_evaluationDefense(Defense defense)
    {
        ...
        tab_evaluationDefense.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_defense_evaluer.setVisible(false);
    ...
    public void load_tab_propositionStage2()
    {
        ...
        tab_propositionStage2.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_propositionStage_etudiant_editer.setVisible(false);
    ...
    public void load_tab_echeance2()
    {
        ...
        tab_echeance2.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_echeance_editer.setVisible(false);
                ...
                {
                    boutons = true;
                    Echeance ech = echeance_DB.find(Integer.parseInt(elementSelected.toString()));
    ...
    public void load_tab_echeance3(TFE tfe)
    {
        ...
        tab_echeance3.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_TFE_echeance.setVisible(false);
    ...
    public void load_tab_echeance4(Stage stage)
    {
        ...
        tab_echeance4.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_stage_echeance.setVisible(false);
    ...
    public void load_tab_stage3()
    {
        ...
        tab_stage3.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_stage_maitreDeStage_evaluer.setVisible(false);
    ...
    public void load_tab_defense3()
    {
        ...
        tab_defense3.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_defense_evaluer_presidentDeJury.setVisible(false);
    ...
    public void load_tab_evaluations_maitreStage(Stage stage)
    {
        ...
        tab_evaluations_maitreStage.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_stage_evaluer.setVisible(false);
    ...
    public void load_tab_evaluations_presidentJury(Defense defense)
    {
        ...
        tab_evaluations_presidentJury.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                form_stage_evaluer.setVisible(false);
    ...
    public void load_cb_presidentJury()
    {
        ...
        for (CritereEvaluation critereEvaluation : critereEvaluationList)
            defense_evaluer_presidentDeJury_critere.addItem(critereEvaluation);
    }
    ...
    public void load_cb_defense()
    {
        ...
        critereEvaluationList = critereEvaluation_DB.fetchAll("defense");
        for (CritereEvaluation critereEvaluation : critereEvaluationList)
            defense_evaluer_critere.addItem(critereEvaluation);
    }
    ...
    public void load_cb_TFE()
    {
        ...
        ArrayList<Technologie> technologiesUtilisees = new ArrayList<Technologie>();
        for (TFE tfe : tfeList)
        {
        ...
        for (Technologie technologie : technologiesUtilisees)
            cb_tfe_technologie.addItem(technologie);
        cb_tfe_technologie.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                load_tab_tfe_filtre();
        ...
        for (String anneeAcademique : tfe_generer_anneesAcademiques(tfeList))
            cb_tfe_anneeAcademique.addItem(anneeAcademique);

        cb_tfe_anneeAcademique.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                load_tab_tfe_filtre();
        ...
        tf_tfe_etudiant.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_cb_TFE2()
    {
        ...
        for (Technologie technologie : technologiesUtilisees)
            cb_tfe_technologie2.addItem(technologie);
        cb_tfe_technologie2.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
        ...
        for (String anneeAcademique : tfe_generer_anneesAcademiques(tfeList))
            cb_tfe_anneeAcademique2.addItem(anneeAcademique);
        cb_tfe_anneeAcademique2.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                load_tab_tfe2_filtre();
        ...
        tf_tfe_etudiant2.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
    ...
    public void load_cb_stage()
    {
        ...
        ArrayList<Technologie> technologieList = technologie_DB.fetchAll();
        for (Technologie technologie : technologieList)
            tc_stage_editer_technologies.addItem(technologie);
        ArrayList<Technologie> technologiesUtilisees = new ArrayList<Technologie>();
        for (Stage stage : stageList)
        {
            ArrayList<Technologie> technologiesStage = stage.getTechnologies();
        ...
        for (Technologie technologie : technologiesUtilisees)
            cb_stage_technologie.addItem(technologie);
        cb_stage_technologie.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
        ...
        ArrayList<LieuStage> lieuStageList = lieuStage_DB.fetchAll();
        for (LieuStage lieuStage : lieuStageList)
            cb_stage_editer_entreprise.addItem(lieuStage);
        ArrayList<LieuStage> lieuxStagesUtilises = new ArrayList<LieuStage>();
        for (Stage stage : stageList)
        {
            LieuStage lieuStageStage = stage.getProposition().getPlace();
        ...
        for (LieuStage lieuStage : lieuxStagesUtilises)
            cb_stage_entreprise.addItem(lieuStage);
        cb_stage_entreprise.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                load_tab_stage_filtre();
        ...
        tf_stage_adresse.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
        ...
        for (String anneeAcademique : stages_generer_anneesAcademiques(stageList))
            cb_stage_anneeAcademique.addItem(anneeAcademique);
        cb_stage_anneeAcademique.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                load_tab_stage_filtre();
        ...
        for (Utilisateur promoteur : promoteurList)
            cb_stage_editer_promoteur.addItem(promoteur);

        cb_stage_editer_maitreDeStage.removeAllItems();
        ArrayList<Utilisateur> maitreDeStageList = user_DB.fetchAll("maitre_stage");
        for (Utilisateur maitreStage : maitreDeStageList)
            cb_stage_editer_maitreDeStage.addItem(maitreStage);
        cb_stage_editer_etudiant.setReadOnly(false);
        cb_stage_editer_etudiant.removeAllItems();

        ArrayList<Utilisateur> etudiantList = user_DB.fetchAll("etudiant_tfe_stage");
        for (Utilisateur etudiant : etudiantList)
            cb_stage_editer_etudiant.addItem(etudiant);
        ...
        for (CritereEvaluation critereEvaluation : critereEvaluationList)
            stage_evaluer_critere.addItem(critereEvaluation);

        stage_defense_presidentJury.removeAllItems();
        ArrayList<Utilisateur> presidentJuryList = user_DB.fetchAll("president_jury");
        for (Utilisateur presidentJury : presidentJuryList)
            stage_defense_presidentJury.addItem(presidentJury);
    }
    ...
    public void load_cb_stage2()
    {
        ...
        for (Technologie technologie : technologiesUtilisees)
            cb_stage_technologie3.addItem(technologie);
        cb_stage_technologie3.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
        ...
        for (LieuStage lieuStage : lieuxStagesUtilises)
            cb_stage_entreprise3.addItem(lieuStage);
        cb_stage_entreprise3.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                load_tab_stage2_filtre();
        ...
        tf_stage_adresse3.addTextChangeListener(new TextChangeListener()
        {
            public void textChange(TextChangeEvent event)
            {
        ...
        for (String anneeAcademique : stages_generer_anneesAcademiques(stageList))
            cb_stage_anneeAcademique3.addItem(anneeAcademique);
        cb_stage_anneeAcademique3.addValueChangeListener(new Property.ValueChangeListener()
        {
            public void valueChange(ValueChangeEvent event)
            {
                load_tab_stage2_filtre();
    ...
    public void load_cb_propositionStage()
    {
        ...
        for (LieuStage entreprise : entrepriseList)
            cb_PropositionStage_editer_entreprise.addItem(entreprise);
        ...
        for (Utilisateur user : userMaitreStageList)
            cb_PropositionStage_valider_maitreDeStage.addItem(user);
        cb_PropositionStage_valider_promoteur.removeAllItems();
        ArrayList<Utilisateur> userPromoteurList = user_DB.fetchAll("professeur");
        for (Utilisateur user : userPromoteurList)
            cb_PropositionStage_valider_promoteur.addItem(user);
        tc_PropositionStage_valider_technologies.removeAllItems();
        DAO_Technologie technologie_DB = new DAO_Technologie();
        ArrayList<Technologie> technologieList = technologie_DB.fetchAll();
        for (Technologie technologie : technologieList)
            tc_PropositionStage_valider_technologies.addItem(technologie);
    }
    ...
    public void load_cb_propositionStage2()
    {
        ...
        ArrayList<LieuStage> entrepriseList = lieuStage_DB.fetchAll();
        for (LieuStage entreprise : entrepriseList)
            cb_PropositionStage_etudiant_editer_entreprise.addItem(entreprise);
    }
    ...
    public void load_cb_maitreStage()
    {
        ...
        ArrayList<CritereEvaluation> critereEvaluationList = critereEvaluation_DB.fetchAll("stage");
        for (CritereEvaluation critereEvaluation : critereEvaluationList)
            stage_evaluer_maitreDeStage_critere.addItem(critereEvaluation);
    }
    ...
    public void load_cb_echeance()
    {
        ...
        userList.addAll(user_DB.fetchAll("etudiant_tfe_stage"));
        for (Utilisateur etudiant : userList)
            tc_echeance_ajouter_utilisateurs.addItem(etudiant);
    }
